...
- توضیح مختصر: بلوپرینت وب‌سایت، مثل نقشه ساختمونه، اما برای سایت
...
- Maybe 2–3 examples of who it's for
...
- Revision policy: 1 round included
- This removes risk. Risk is why people don't buy.

- اگه بدردتون نخورد، تا ۷ روز بعد تحویل، مبلغ رو پس میدم.

## 9. "What do other people say?"

- Testimonials (once you have them)
- If you don't have testimonials yet: be honest. "This is new. I'm offering the first 3 blueprints at a discount in exchange for feedback."
- Screenshots, quotes, names if allowed

No testimonials yet is fine. Fake ones are not. Never fake.

## 10. "What do I do now?"

- One CTA. Not five.
- A form (name, contact, what they need) 
- An Eitaa button as backup
- Maybe: "Not sure? Message me and ask."

- تنها کاری که باید بکنی، اینه که بزن روی این دکمه، و توی ایتا برای من یه «سلام» یا ایموجی بفرست! من اینجام که کمکت کنم، هر کاری داشتی بهم پیام بده...

## 11. "Who are you? Can I trust you?"

- Real name, real photo
- Real contact (Eitaa, phone, email)
- Real location if relevant
- Maybe a link to your personal site or portfolio

- محمدمهدی بهرامی
- دانشجوی رشته نرم‌افزار، برنامه‌نویس فول‌استک با ۲ سال سابقه، مدرس توی سایت تاپلرن، سایتم اینجاست، و ...

## 12. FAQ (optional but useful)

- How long does it take?
- What do you need from me?
- Do you build the site too? (No — this is the plan, not the build. But here are people who can.)
- Can I get a refund?
- Is this for Iranian businesses only?
- What if I already have a site?

- چقدر طول می‌کشه؟ بستگی به سرعت خودتون داره، می‌تونه یه روزه تموم بشه، یا ممکنه یه ماه طول بکشه... البته معمولا بین ۳ تا ۷ روز طول می‌کشه...
- از من چی می‌خواین؟ چند تا سوال ساده درباره کسب‌وکارتون، رقباتون، و اهدافتون می‌پرسم... همین...
- خودت هم سایت رو می‌سازی؟ نخیر، بلوپرینت وب‌سایت یه نقشه هست، بهتون می‌گه که برای ساخت سایتتون دقیقا پیش کی برین و چه چیزهایی بخرین و اینا... (البته خودم هم می‌تونم، ولی فقط اگه بهترین مورد باشم بهتون پیشنهاد میدم)
- می‌تونم پولم رو پس بگیرم؟ آره، تا ۷ روز بعد تحویل، اگه از بلوپرینت راضی نبودین، به دردتون نخورد، یا اگه نتوستم درستش کنم که بهتون کمک بکنه، مبلغ کامل بهتون بر می‌گرده، با خیال راحت شروع کنین...
- فقط برای شرکت‌های ایرانی هست؟ هم آره و هم نه. کسب‌وکارهای ایده‌آل بلوپرینت ایرانی هستن، ولی پیام بدین ببینم که می‌تونم کمکتون کنم یا نه...
- اگه سایت داشته باشی: نگاهش میکنم. اگه قابل بهبود باشه، دقیقاً میگم چی رو چطور درست کنی. اگه لازم باشه از صفر بسازی، نقشهش رو میدم. **خودم مهاجرت انجام نمیدم** — ولی توی بلوپرینت دقیقاً نوشتم که مهاجرت چطور باید انجام بشه، چه برای دیتابیس، چه برای سئو، چه برای ریدایرکتها، تا بتونی به هر کسی که میخوای بسپاری.